---- MODULE PlanConcurrency_TTrace_1775898695 ----
...
_inv ==
    ~(
        ...
        opCurrentPlan = ("none")
        /\
        planPhase = ([p1 |-> "Applying", p2 |-> "none"])
        /\
        planHash = ([p1 |-> "h1", p2 |-> "none"])
        /\
        planExists = ([p1 |-> TRUE, p2 |-> FALSE])
        /\
        opComputedHash = ("none")
        /\
        policyCurrentPlanRef = ("p1")
        /\
        opAlive = (TRUE)
        /\
        opStep = ("acquired_lock")
        /\
        policyLastError = ("none")
        /\
        planAnnotation = ([p1 |-> "approve", p2 |-> "none"])
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PlanConcurrency_TTrace_1775898695.json", _TETrace)
...
\*
\*trace == IODeserialize("PlanConcurrency_TTrace_1775898695.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG PlanConcurrency_TTrace_1775898695 ----
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Apr 11 09:11:36 UTC 2026