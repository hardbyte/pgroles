---- MODULE PlanLifecycle_TTrace_1775897995 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PlanLifecycle_TTrace_1775897995.json", _TETrace)
...
\*
\*trace == IODeserialize("PlanLifecycle_TTrace_1775897995.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([lastError |-> "none",operatorHoldsLock |-> TRUE,dbHash |-> "h1",operatorComputing |-> TRUE,policyReady |-> FALSE,appliedHash |-> "h1",operatorAlive |-> TRUE,planPhase |-> "Applied",approvalWasChecked |-> TRUE,planHash |-> "h1",planAnnotation |-> "none"]),
    ([lastError |-> "none",operatorHoldsLock |-> TRUE,dbHash |-> "h1",operatorComputing |-> TRUE,policyReady |-> TRUE,appliedHash |-> "h1",operatorAlive |-> TRUE,planPhase |-> "Pending",approvalWasChecked |-> FALSE,planHash |-> "h1",planAnnotation |-> "none"]),
    ([lastError |-> "none",operatorHoldsLock |-> TRUE,dbHash |-> "h1",operatorComputing |-> TRUE,policyReady |-> TRUE,appliedHash |-> "h1",operatorAlive |-> TRUE,planPhase |-> "Pending",approvalWasChecked |-> FALSE,planHash |-> "h1",planAnnotation |-> "reject"]),
    ([lastError |-> "none",operatorHoldsLock |-> TRUE,dbHash |-> "h1",operatorComputing |-> TRUE,policyReady |-> TRUE,appliedHash |-> "h1",operatorAlive |-> TRUE,planPhase |-> "Rejected",approvalWasChecked |-> FALSE,planHash |-> "h1",planAnnotation |-> "reject"])
    >>
----
...
---- CONFIG PlanLifecycle_TTrace_1775897995 ----
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Apr 11 08:59:56 UTC 2026