---- MODULE PlanRevalidation_TTrace_1786830534 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PlanRevalidation_TTrace_1786830534.json", _TETrace)
...
\*
\*trace == IODeserialize("PlanRevalidation_TTrace_1786830534.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([policyGen |-> 1,approved |-> FALSE,dbEffects |-> "e1",summaryEffects |-> "e1",planGen |-> 0,driftsLeft |-> 0,planEffects |-> "e1",planPhase |-> "Pending",lostApproval |-> FALSE,editsLeft |-> 1]),
    ([policyGen |-> 1,approved |-> TRUE,dbEffects |-> "e1",summaryEffects |-> "e1",planGen |-> 0,driftsLeft |-> 0,planEffects |-> "e1",planPhase |-> "Pending",lostApproval |-> FALSE,editsLeft |-> 1]),
    ([policyGen |-> 1,approved |-> FALSE,dbEffects |-> "e1",summaryEffects |-> "e1",planGen |-> 1,driftsLeft |-> 0,planEffects |-> "e1",planPhase |-> "Pending",lostApproval |-> TRUE,editsLeft |-> 1])
    >>
----
...
---- CONFIG PlanRevalidation_TTrace_1786830534 ----
CONSTANTS
