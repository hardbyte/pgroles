---- MODULE PlanRevalidation_TTrace_1786830543 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PlanRevalidation_TTrace_1786830543.json", _TETrace)
...
\*
\*trace == IODeserialize("PlanRevalidation_TTrace_1786830543.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([policyGen |-> 0,approved |-> FALSE,dbEffects |-> "none",summaryEffects |-> "e1",planGen |-> 0,driftsLeft |-> 0,planEffects |-> "e1",planPhase |-> "Pending",lostApproval |-> FALSE,editsLeft |-> 2]),
    ([policyGen |-> 0,approved |-> FALSE,dbEffects |-> "none",summaryEffects |-> "none",planGen |-> 0,driftsLeft |-> 0,planEffects |-> "e1",planPhase |-> "Pending",lostApproval |-> FALSE,editsLeft |-> 2])
    >>
----
...
---- CONFIG PlanRevalidation_TTrace_1786830543 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Aug 15 21:49:04 UTC 2026