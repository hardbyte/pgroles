---- MODULE PlanRevalidation_TTrace_1786830533 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PlanRevalidation_TTrace_1786830533.json", _TETrace)
...
\*
\*trace == IODeserialize("PlanRevalidation_TTrace_1786830533.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([policyGen |-> 1,approved |-> FALSE,dbEffects |-> "none",summaryEffects |-> "none",planGen |-> 0,driftsLeft |-> 0,planEffects |-> "e1",planPhase |-> "Pending",lostApproval |-> FALSE,editsLeft |-> 1])
    >>
----
...
---- CONFIG PlanRevalidation_TTrace_1786830533 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Aug 15 21:48:54 UTC 2026