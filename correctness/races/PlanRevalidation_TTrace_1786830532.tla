---- MODULE PlanRevalidation_TTrace_1786830532 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PlanRevalidation_TTrace_1786830532.json", _TETrace)
...
\*
\*trace == IODeserialize("PlanRevalidation_TTrace_1786830532.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([policyGen |-> 0,approved |-> FALSE,dbEffects |-> "e1",summaryEffects |-> "none",planGen |-> 0,driftsLeft |-> 1,planEffects |-> "none",planPhase |-> "none",lostApproval |-> FALSE,editsLeft |-> 2]),
    ([policyGen |-> 0,approved |-> FALSE,dbEffects |-> "e1",summaryEffects |-> "e1",planGen |-> 0,driftsLeft |-> 1,planEffects |-> "e1",planPhase |-> "Pending",lostApproval |-> FALSE,editsLeft |-> 2]),
    ([policyGen |-> 1,approved |-> FALSE,dbEffects |-> "none",summaryEffects |-> "e1",planGen |-> 0,driftsLeft |-> 1,planEffects |-> "e1",planPhase |-> "Pending",lostApproval |-> FALSE,editsLeft |-> 1]),
    ([policyGen |-> 1,approved |-> FALSE,dbEffects |-> "none",summaryEffects |-> "none",planGen |-> 1,driftsLeft |-> 1,planEffects |-> "none",planPhase |-> "Pending",lostApproval |-> FALSE,editsLeft |-> 1])
    >>
----
...
---- CONFIG PlanRevalidation_TTrace_1786830532 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Aug 15 21:48:53 UTC 2026