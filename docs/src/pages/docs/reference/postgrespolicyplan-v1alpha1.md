...
| Path | Definition |
| --- | --- |
| `spec` | **object; required.** Spec for a &#96;PostgresPolicyPlan&#96; custom resource.  Represents a computed reconciliation plan for a &#96;PostgresPolicy&#96;. Plans are created by the operator and may require explicit approval before execution. |
...
| `spec.origin` | **object; optional.** Origin of this plan. Omitted for ordinary durable reconciliation plans. **Constraints:** {"nullable":true}. |
...
| `spec.policyRef` | **object; required.** Reference to the policy that generated this plan. |
...
| `spec.scope` | **object; optional.** Narrow execution scope for a non-durable plan. **Constraints:** {"nullable":true}. |
...
| `status.sqlRef` | **object; optional.** Reference to ConfigMap containing the full SQL (for large plans). **Constraints:** {"nullable":true}. |
